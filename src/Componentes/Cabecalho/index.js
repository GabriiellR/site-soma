        ...
        <nav class="navbar navbar-expand-lg d-flex gap-3 p-4 sticky-top bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <Link to="/" className={`fs-4 mx-2 nav-link hover text-decoration-none text-black fw-normal ${pagina.pathname == '/' ? 'text-yellow-soma fw-bold' : ''}`}>Inicio</Link>
                        </li>
                        <li class="nav-item ">
                            <Link to="sobrenos" className={`fs-4 mx-2 hover nav-link text-decoration-none text-black fw-normal ${pagina.pathname == '/sobrenos' ? 'text-yellow-soma fw-bold' : ''}`}>Sobre nós</Link>
                        </li>
                        <li class="nav-item ">
                            <Link to="servicos" className={`fs-4 mx-2 hover nav-link text-decoration-none text-black fw-normal ${pagina.pathname == '/servicos' ? 'text-yellow-soma fw-bold' : ''}`}>Serviços</Link>
                        </li>
                        <li class="nav-item ">
                            <Link to="parceiros" className={`fs-4 mx-2 hover nav-link text-decoration-none text-black fw-normal ${pagina.pathname == '/parceiros' ? 'text-yellow-soma fw-bold' : ''}`}>Parceiros</Link>
                        </li>
                        <li class="nav-item ">
